...
RSpec.describe Address::Valid8r do
  ...
  before do
    ...
    allow(Clients::SmartyClient).to receive(:new).and_return(mocked_smarty_client)
  end
  ...
  let(:mocked_smarty_client) do
    instance_double(
      Clients::SmartyClient,
      validate_addresses: validated_addresses
    )
  end
